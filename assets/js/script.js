jQuery(document).ready(function($) {
        ...
        let content = `
            <table style="width:100%; border-collapse:collapse; background:#f8fafc; font-size:10px !important; color:#334155; margin-bottom:6px; border:1px solid #e2e8f0; border-radius:4px;">
                ...
                <tr>
                    ...
                    <td style="padding:4px; border-bottom:1px solid #e2e8f0;"><b>Hotel:</b> ${hotel}</td>
                </tr>
                <tr>
                    <td colspan="2" style="padding:4px; border-bottom:1px solid #e2e8f0;"><b>Veh:</b> ${veh}</td>
                </tr>
                <tr>
                    <td colspan="2" style="padding:4px;"><b>Rooms:</b> ${rms}</td>
                </tr>
            </table>
            ...
            <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:4px; padding:6px; margin-bottom:6px;">
                ...
                <div style="font-size:9px !important; color:#451a03; line-height:1.4; font-weight:600;">
                    ✓ Jammu / Srinagar Pickup and drop<br>
                    ✓ Sightseeing & Transfers<br>
                    ✓ All Accommodation<br>
                    ✓ Breakfast & Dinner
                </div>
                <div style="font-size:8px !important; color:#dc2626; margin-top:4px; font-weight:700; font-style:italic; border-top:1px dashed #fcd34d; padding-top:4px;">* Anything Not mentioned is all exclusions</div>
            </div>
    ...
    $('#utpc-edit-form').submit(function(e) {
        e.preventDefault();
        if($('#edit-list-f-r').children().length === 0) { alert("Error: You must select at least one room."); return; }
        if($('#edit_tour_id').val() === 'custom_trip' && $('#edit-list-f-v').children().length === 0) { alert("Error: You must select at least one vehicle."); return; }
